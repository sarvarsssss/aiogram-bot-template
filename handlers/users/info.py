...
async def send_link(message: Message):
    ...
    await message.reply_photo(photo_id,caption="Amazon Asoschisi \nSeryozniy yurishi yoqtiralla \nJuda chuqur O'ylidila Yaqnda shu chuqurga o'zlari tushub ketadila \nShiori: 'Life is good but it can be better'" , reply_markup=menufriends)
...
async def send_link(message: Message):
    ...
    await message.reply_photo(photo_id, caption="Elektra set Direktori \nJuda aqlli aka Yaxshi maslahatla chiqadi \nYaqnda to'y  bo'lad Shundan so'ng uni ko'rmadik \nShiori: 'uylanish uylanish uylanish'", reply_markup=menufriends)
